...
def create_stripe_session(request):
    ...
    session = stripe.checkout.Session.create(
        ...
        mode='payment',
        success_url='https://e04b-41-90-172-132.ngrok-free.app/api/stripe_api/stripe-payment-success/',
        cancel_url='https://e04b-41-90-172-132.ngrok-free.app.app/api/stripe_api/stripe-payment-cancelled/',
    )
