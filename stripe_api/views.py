...
def create_stripe_session(request):
    ...
    session = stripe.checkout.Session.create(
        ...
        mode='payment',
        success_url='https://127e-41-90-172-54.ngrok-free.app/api/stripe_api/stripe-payment-success/',
        cancel_url='https://127e-41-90-172-54.ngrok-free.app/api/stripe_api/stripe-payment-cancelled/',
    )
